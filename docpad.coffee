    ...
    templateData:
        ...
        site:
            ...
            styles: [
                ...
                '/css/style.css'
                'http://fonts.googleapis.com/css?family=Montserrat:400,700|Open+Sans:400italic,700italic,400,700'
            ]
        ...
        getComments: (slug) ->
            dt = new Date("October 13, 2014 11:13:00")
            comments = [
                    {author:'Bob Builder',mtime: dt,content:'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.'},
                    {author: 'John Smith',mtime: dt,content:'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.'}
                ]
            return comments
        
        getRecentPosts: (num) ->
            num = num || 20
            posts = @getCollection('posts').query({limit:num}).toJSON()
            return posts
